...
public class upcomingtvseriesFragment extends Fragment {
    ...
    private upcomingtvseriesadapter adpaterclass;
    private Toolbar mtoolbars;


    public upcomingtvseriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_upcomingtvseries, container, false);

        mtoolbars=(Toolbar) view.findViewById(R.id.main_pageappbar);
        mtoolbars.setTitle("Upcoming TvSeries");


        mrecyclerview=(RecyclerView)view.findViewById(R.id.upcomingtvseriesrecyclerview);
        ...
        adpaterclass = new upcomingtvseriesadapter(movielist, getActivity());
    ...
    private void fetchretrofit() {
        ...
        Call<Movieresponse2> call = fetchdata.gettopratedtvseries();
